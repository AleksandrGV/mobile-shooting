document.addEventListener('DOMContentLoaded', function() {
        ...
        const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwi0-g6YX1mbXmTpOZ68c0H04I0DkFUJV1mXR6UBafNpYpnavyG04otdwH_c9CG3Zl2/exec';
         ...
         * Валидация формы
         */
        function validateForm(name, email, phone, privacyAgreed) {
            if (!name || !email || !phone) {
        ...
        form.addEventListener('submit', async function(e) {
            ...
            logDebug('📊 Данные формы:', { name, email, phone, tariff, privacyAgreed });
            
            // Валидация
            const validationError = validateForm(name, email, phone, privacyAgreed);
            if (validationError) {
